...
Использовать это решение возможно только при отключенном аппаратном ускорении NAT'а. При включенном, из-за того, что fwmark теперь активно используется самой прошивкой решение работать не будет. Как правильно при этом маркировать трафик можно посмотреть [здесь](https://keenetic-gi.ga/2022/12/17/adguardhome-and-selective-routing.html).
